...
const html = fs.readFileSync(path.resolve(__dirname, '../Aphrodite_2.html'), 'utf8');

let dom
let container

describe('Aphrodite_2.html', () => {
  beforeEach(() => {
  ...
  it('renders a heading 2 element', () => {
    ...
    expect(getByText(container, 'JUMPING JACKS')).toBeInTheDocument()
  })
